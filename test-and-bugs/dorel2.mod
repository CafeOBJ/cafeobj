...
apply MUTEX-DATA.A-pre within term . -- it could be applied
-- rule MUTEX-DATA.15 is [b-pre] : A B-encs av => A B-bcs non-av
apply MUTEX-DATA.B-pre within term . -- it couldn't be applied
close
...
apply hyp2 within term .
apply hyp3 within term .
apply MUTEX-DATA.B-pre within term . -- it could be applied
apply MUTEX-DATA.A-pre within term . -- it couldn't be applied
close
